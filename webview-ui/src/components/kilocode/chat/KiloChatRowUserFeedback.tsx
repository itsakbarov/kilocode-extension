...
export const KiloChatRowUserFeedback = ({ message, isStreaming, onChatReset }: KiloChatRowUserFeedbackProps) => {
	...
	if (isEditing) {
		return (
			<div className="bg-vscode-editor-background border rounded-xs p-1 overflow-hidden whitespace-pre-wrap">
				<textarea
					className="w-full h-24 p-2 border rounded-lg bg-vscode-input-background text-vscode-input-foreground"
					value={editedText}
	...
	return (
		<div className="bg-vscode-editor-background border rounded-xs p-1 overflow-hidden whitespace-pre-wrap">
			<div className="flex justify-between border border-vscode-panel-border rounded-lg p-2 text-white">
