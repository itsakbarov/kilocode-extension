 ...
 *
 * This class manages the state for the marketplace view in the O Code extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the O Code extensions interface
