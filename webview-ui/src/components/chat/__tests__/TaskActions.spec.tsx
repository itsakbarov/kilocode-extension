	...
	useTranslation: () => ({
		t: (key: string) => {
			const translations: Record<string, string> = {
				...
				"chat:task.connectToCloudDescription": "Sign in to O Code Cloud to share tasks",
				"chat:task.sharingDisabledByOrganization": "Sharing disabled by organization",
				"account:cloudBenefitsTitle": "Connect to O Code Cloud",
				"account:cloudBenefitsSubtitle": "Sign in to O Code Cloud to share tasks",
...
describe("TaskActions", () => {
	...
	describe.skip("Unauthenticated User Login Flow", () => {
		...
		it("shows connect to cloud option when not authenticated", () => {
			...
			expect(screen.getByText("Connect to O Code Cloud")).toBeInTheDocument()
			expect(screen.getByText("Sign in to O Code Cloud to share tasks")).toBeInTheDocument()
