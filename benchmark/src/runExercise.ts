...
export async function run() {
	...
	const extension = vscode.extensions.getExtension<RooCodeAPI>("ocode.o-code")
	...
	/**
	 * Wait for the O Code to be ready to accept tasks.
	 */

	await waitUntilReady({ api })

	/**
	 * Configure O Code as needed.
	 *
