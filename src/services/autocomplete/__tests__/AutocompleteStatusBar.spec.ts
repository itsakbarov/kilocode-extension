...
vi.mock("../../../i18n", () => ({
	t: vi.fn((key: string) => {
		const translations: Record<string, string> = {
			...
			"kilocode:autocomplete.statusBar.tooltip.basic": "O Code Autocomplete",
			"kilocode:autocomplete.statusBar.tooltip.disabled": "O Code Autocomplete (disabled)",
...
describe("AutocompleteStatusBar", () => {
	...
	it("should update enabled state to false and render correctly", () => {
		...
		expect(statusBar.statusBar.tooltip).toBe("O Code Autocomplete (disabled)")
	})
