...
export const metadata: Metadata = {
	title: "Terms of Service - O Code",
	description:
		"Terms of Service for O Code Cloud. Learn about our service terms, commercial conditions, and legal framework.",
}
				...
				<div className="prose prose-lg mx-auto max-w-4xl dark:prose-invert">
					...
					<ul className="lead">
						<li>
							...
							executed by O Code and the customer that references these TOS; <strong>and</strong>
						</li>
						<li>
							<strong>(b)</strong> any{" "}
					...
					<p>
						If O Code and Customer later execute a Master Subscription Agreement (&quot;
						...
						<table className="min-w-full border-collapse border border-border">
							...
							<tbody>
								...
								<tr className="bg-muted/25">
									...
									<td className="border border-border px-4 py-2">
										O Code maintains commercially reasonable administrative, physical, and technical
										safeguards
									</td>
								</tr>
								<tr>
									...
									<td className="border border-border px-4 py-2">
										O Code <strong>does not</strong> use Customer Content to train, fine-tune, or
								...
								<tr>
									...
									<td className="border border-border px-4 py-2">
										O Code may identify Customer (name & logo) in marketing materials unless
					...
					<ol>
						...
						<li>
							...
							<br />
							Deleted – O Code offers no trials, pilots, betas, or SLA credits under these TOS.
						</li>
						<li>
					...
					<p>
						...
						) explains how O Code collects and handles personal information. If Customer requires a DPA,
						email{" "}
					...
					<ol>
						<li>
							...
							<br />
							Customer may not assign the Agreement without O Code&apos;s prior written consent, except to
							a successor in a merger or sale of substantially all assets.
						</li>
						<li>
						...
						<li>
							...
							<br />O Code may update these TOS by posting a revised version at the same URL and emailing
