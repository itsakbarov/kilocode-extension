...
export const features: Feature[] = [
	{
		...
		description:
			"O Code puts a team of agentic AI assistants directly in your editor, with the power to plan, write, and fix code across multiple files.",
		size: "large",
	},
	{
		...
		description:
			"From coding to debugging to architecture, O Code has a mode for every dev scenario—just switch on the fly.",
		size: "small",
	},
	{
		...
		description:
			"O Code reads your entire codebase, preserving valid code through diff-based edits for seamless multi-file refactors.",
		size: "small",
	},
	{
		...
		description:
			"Bring your own model or use local AI—no vendor lock-in. O Code is free, open, and adaptable to your needs.",
		size: "large",
	},
	{
		...
		description:
			"Approve or deny commands as needed. O Code automates your dev workflow while keeping oversight firmly in your hands.",
		size: "small",
	},
	{
		...
		description:
			"Create or tweak modes, define usage rules, and shape O Code’s behavior precisely—your code, your way.",
		size: "small",
	},
	{
		...
		description:
			"Seamlessly test and verify your web app directly from VS Code—O Code can open a browser, run checks, and more.",
		size: "small",
	},
]
