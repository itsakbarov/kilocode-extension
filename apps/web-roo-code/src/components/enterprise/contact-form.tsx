...
export function ContactForm({ formType, buttonText, buttonClassName }: ContactFormProps) {
	...
	const formDescription =
		formType === "early-access"
			? "Fill out the form below to collaborate in shaping O Code's enterprise solution."
			: "Fill out the form below to see O Code's enterprise capabilities in action."
