...
suite.skip("O Code use_mcp_tool Tool", function () {
	...
	test("Should request MCP filesystem read_file tool and complete successfully", async function () {
		...
		await sleep(2000) // Wait for O Code to fully initialize
		...
		try {
			...
			// Make a small modification to trigger the save event, without this O Code won't load the MCP server
