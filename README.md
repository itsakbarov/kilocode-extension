<p align="center">
  <a href="https://marketplace.visualstudio.com/items?itemName=ocode.o-code"><img src="https://img.shields.io/visual-studio-marketplace/v/kilocode.Kilo-Code.svg?label=VS%20Code%20Marketplace" alt="VS Code Marketplace"></a>
  ...
  <a href="https://x.com/o_fndn"><img src="https://img.shields.io/twitter/follow/o_fndn?style=flat&logo=x&color=555" alt="X (Twitter)"></a>
...
## How to get started with O Code

1.  Install the O Code extension from the [VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=kilocode.Kilo-Code).
