...
build_extension() {
  echo "🔨 Building the O Code extension..."
...
echo -n "🗄️ Syncing O Code evals database... "
...
read -p "💻 Do you want to build a new version of the O Code extension? [currently $current_version] (y/N): " build_extension
