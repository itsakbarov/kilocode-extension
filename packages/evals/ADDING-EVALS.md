...
This guide explains how to add new coding exercises to the O Code evals system. The evals system is a distributed evaluation platform that runs AI coding tasks in isolated VS Code environments to test AI coding capabilities across multiple programming languages.
...
version = "0.1.0"
description = "Python exercises for O Code evals"
requires-python = ">=3.9"
dependencies = [
    "pytest>=8.3.5",
]
...
Adding a new programming language requires changes to both the evals repository and the main O Code repository.
