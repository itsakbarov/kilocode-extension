...
describe("WebAuthService", () => {
	...
	describe("login", () => {
		...
		it("should handle errors during login", async () => {
			...
			await expect(authService.login()).rejects.toThrow("Failed to initiate O Code Cloud authentication")
			expect(mockLog).toHaveBeenCalledWith("[auth] Error initiating O Code Cloud auth: Error: Crypto error")
		})
	})
	...
	describe("handleCallback", () => {
		...
		it("should handle invalid parameters", async () => {
			...
			expect(mockShowInfo).toHaveBeenCalledWith("Invalid O Code Cloud sign in url")
		...
		it("should validate state parameter", async () => {
			...
			await expect(authService.handleCallback("code", "different-state")).rejects.toThrow(
				"Failed to handle O Code Cloud callback",
			)
		...
		it("should successfully handle valid callback", async () => {
			...
			expect(mockShowInfo).toHaveBeenCalledWith("Successfully authenticated with O Code Cloud")
		})
	...
	describe("logout", () => {
		...
		it("should clear credentials and call Clerk logout", async () => {
			...
			expect(mockShowInfo).toHaveBeenCalledWith("Logged out from O Code Cloud")
		})
